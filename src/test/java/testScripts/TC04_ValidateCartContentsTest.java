...
public class TC04_ValidateCartContentsTest extends BaseTest {
    @Test
    public void testValidateCartContents() throws InterruptedException {
        ...
        String actual_SubTotal="Rs. 10.44";
        String expected_SubTotal=addToCartPage.getSubTotalText().getText();
        Assert.assertEquals(actual_SubTotal,expected_SubTotal,"Sub total is not displayed");
    }
}
